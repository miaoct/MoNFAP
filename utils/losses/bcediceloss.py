...
class BCEDiceLoss(nn.Module):
    ...
    def __init__(self, scale_factor=1.0, alpha=1.0, beta=1.0, reduction='mean', ignore_index=None, lowest_loss_value=None):
    ...
    def forward(self, prediction, target):
        ...
        # calculate loss
        loss = self.alpha * self.bce(prediction, target) + self.beta * self.dice(prediction, target)
