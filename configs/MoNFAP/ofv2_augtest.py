...
from .._base_ import DATASET_CFG_OpenForensics_Aug


# deepcopy
SEGMENTOR_CFG = copy.deepcopy(SEGMENTOR_CFG)
# modify dataset config
SEGMENTOR_CFG['dataset'] = DATASET_CFG_OpenForensics_Aug.copy()
...
SEGMENTOR_CFG['work_dir'] = 'Forgery2Mask_convnextv2_atto_ffiw'
SEGMENTOR_CFG['logfilepath'] = 'Forgery2Mask_convnextv2_ffiw'
SEGMENTOR_CFG['resultsavepath'] = 'Forgery2Mask_convnextv2_ffiw_results.pkl'
