'''ManualFake_1024x1024'''
import os


'''DATASET_CFG_ManualFake_1024x1024'''
DATASET_CFG_ManualFake = {
    'type': 'Pixel_ManualFake',
    'rootdir': './data/preprocessed/',
    'osn_list': ['untrans', 'facebook', 'tiktok', 'wechat', 'whatsapp', 'youtube'],
    'real_training': True,
    'train': {
        'data_pipelines': [
